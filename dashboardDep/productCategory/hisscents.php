		...
		<div class="col-sm-8 product-data">
			<div class="data-my-product">
				...
				<ul class="myproducts">
						...
						<li><a class="btn btn-primary btn-dashboard" href="./slimingcofee.php" role="button">Slimming Coffee</a></li>
						<li><a class="btn btn-primary btn-dashboard" href="./tints.php" role="button">Tints</a></li>
						<li><a class="btn btn-primary btn-dashboard active" href="./hisscents.php" role="button">His Scents</a></li>
