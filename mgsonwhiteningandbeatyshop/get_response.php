<?php
	...
	if((isset($_POST['name'])&& $_POST['name'] !='') && (isset($_POST['email'])&& $_POST['email'] !=''))
	{
		...
		$sql="INSERT INTO contactus (name,email,department,subject,phone,comments,created_date) VALUES ('".$yourName."','".$yourEmail."','".$department."','".$subject."','".$yourPhone."','".$comments."','".$created_date."')";
