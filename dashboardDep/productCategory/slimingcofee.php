      ...
      <li><a href="./../mycontract.php">My Contract</a></li>
		...
		<div class="col-sm-8 product-data">
			<div class="data-my-product">
				<h2>My Products</h2>
				<ul class="myproducts">
						<li><a class="btn btn-primary btn-dashboard" href="./../myproducts.php" role="button">Facial Care</a></li>
						<li><a class="btn btn-primary btn-dashboard" href="./bodycare.php" role="button">Body Care</a></li>
						<li><a class="btn btn-primary btn-dashboard" href="./haircare.php" role="button">Hair Care</a></li>
						<li><a class="btn btn-primary btn-dashboard active" href="./slimingcofee.php" role="button">Slimming Coffee</a></li>
						<li><a class="btn btn-primary btn-dashboard" href="./tints.php" role="button">Tints</a></li>
						<li><a class="btn btn-primary btn-dashboard" href="./hisscents.php" role="button">His Scents</a></li>
						<li> <a class="btn btn-primary btn-dashboard" href="./herscents.php" role="button">Her Scents</a></li>
						<li><a class="btn btn-primary btn-dashboard" href="./oil.php" role="button">Oils</a></li>
				</ul>
				<h2>Slimming Coffee</h2>
