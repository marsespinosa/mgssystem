        ...
        <p class="logout-btm"><a href="contact.php">Help?</a></p>
  		...
  		<div class="col-sm-8 product-data">
  			<div class="data-my-product">
  				<h2>My Orders</h2>
  				<ul class="myproducts">
  						<li><a class="btn btn-primary btn-dashboard active" href="#" role="button">Unpaid</a></li>
  						...
  						<li><a class="btn btn-primary btn-dashboard" href="./Order/orderreceived.php" role="button">Received</a></li>
  				</ul>
  				<h2>All Orders</h2>
            ...
            /*$sql = "SELECT * FROM placeorder where id_users=' ". $id ." '";*/
            ...
            if ($result->num_rows > 0) {
              ...
              echo "
                  <tr>
                    <th scope='row'>".$row["placeorder_id"]."</th>
