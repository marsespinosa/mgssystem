		...
		<div class="col-sm-8 product-data">
			<div class="data-my-product">
				...
				<ul class="myproducts">
						...
						<li><a class="btn btn-primary btn-dashboard active" href="./bodycare.php" role="button">Body Care</a></li>
						...
						<li><a class="btn btn-primary btn-dashboard" href="././tints" role="button">Tints</a></li>
