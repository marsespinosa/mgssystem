	  ...
	  <div class="row">
		...
		<div class="col-sm-8 product-data">
			...
			<div class="row cols-dashboard-right ctmdb">
  				...
  				<div class="col">
  			       <h3><a class="btn btn-primary btn-dashboard active" href="pendingrequest.php" role="button">Pending Request</a></h3>
  				</div>
			</div>
			<div class="row">
			...
			?></h2>
					...
					$sel_query = "SELECT products.id_product, products.product_name, products.date_ordered, products.ordered_pcs,products.product_status, depotusers.id_users, depotusers.depot_name
						FROM products
						INNER JOIN  depotusers ON products.id_product = depotusers.id_users where product_status = '$onprogress' ";
