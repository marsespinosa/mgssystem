			...
			<div class="col-sm-8">
				<h2>Production Staff</h2>
				  <div class="row cols-dashboard-right ctmdb">
						<div class="col">
							<h3>
								<a class="btn btn-primary btn-dashboard" href="index.php" role="button">Management Staff</a>
							</h3>
						</div>

						<div class="col">
							<h3>
								<a class="btn btn-primary btn-dashboard active" href="productionstaff.php" role="button">Production Staff</a>
							</h3>
						</div>
						<div class="col">
				...
				<div class="row data-tables-prod">
						...
						<table class='table table-striped table-hover' >
							<thead>
								...
								<?php
									...
									require('../db.php');
			            $currentposition = 'production_staff';
									$sql = "SELECT  id_admin, employee_id, admin_name, admin_position, contact_number, admin_email FROM adminusers WHERE admin_position='$currentposition'";
					...
					<div class="download-data-tab">
							<p>
								...
								<a href="#" class="btn btn-danger" >Edit Details</a>
