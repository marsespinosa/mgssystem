			...
			<div class="col-sm-8">
				<h2>Production Staff</h2>
				  <div class="row cols-dashboard-right ctmdb">
						...
						<div class="col">
							<h3><a class="btn btn-primary btn-dashboard active" href="renewals.php" role="button">Renewals</a></h3>
						</div>
				...
				<div class="row data-tables-prod">
					<div class="col ctmta">
			            ...
			            $dateupdate = date("Y-m-d H:i:s");;
									$sql = "SELECT  id_users, depot_name, depot_email, depot_contractnumber, renewaldate FROM depotusers WHERE renewaldate='$dateupdate'";
									  ...
									  while($row = $result->fetch_assoc()) {
										echo "
												<tr>
												  ...
												  <td>" . $row["depot_email"]. "</td>
												  <td>" . $row["depot_contractnumber"]. "</td>
